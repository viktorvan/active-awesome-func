...
let private gitHubUsernameRaw = getEnvironmentVariable "GITHUB_USERNAME"
let private gitHubPasswordRaw = getEnvironmentVariable "GITHUB_PASSWORD"
...
let gitHubRepoUrlWithAuth = gitHubRepo |> sprintf " https://%s:%s@github.com/%s" gitHubUsernameRaw gitHubPasswordRaw
